<?php
// Dê um Find Replace (CASE SENSITIVE!) em Artigos pelo nome do seu post type 

class Artigos
{
    const NAME = 'Artigos';
    const MENU_NAME = 'Artigos';
    ...
    static function register()
    {
        register_post_type(self::$post_type, array(
            'labels' => array(
                ...
                'singular_name' => _x('Artigos', 'post type singular name', 'SLUG'),
                'add_new' => _x('Adicionar Novo', 'image', 'SLUG'),
                'add_new_item' => __('Adicionar novo Artigos', 'SLUG'),
                'edit_item' => __('Editar Artigos', 'SLUG'),
                'new_item' => __('Novo Artigos', 'SLUG'),
                'view_item' => __('Ver Artigos', 'SLUG'),
                'search_items' => __('Search Artigos', 'SLUG'),
                'not_found' => __('Nenhum Artigos Encontrado', 'SLUG'),
                'not_found_in_trash' => __('Nenhum Artigos na Lixeira', 'SLUG'),
                'parent_item_colon' => ''
            ),
            'public' => true,
